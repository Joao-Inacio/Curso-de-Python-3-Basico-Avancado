...
def bake_time_remaining(mint):
    ...
    """
    return EXPECTED_BAKE_TIME - mint


#TODO: Define the 'preparation_time_in_minutes()' function below.
# You might also consider using 'PREPARATION_TIME' here, if you have it defined.
def preparation_time_in_minutes(mint):
    """Calculate the preparation time.
    :param mint: int the number of lasagna layers made
    ...
    """
    return mint * PREPARATION_TIME


#TODO: define the 'elapsed_time_in_minutes()' function below.
# Remember to add a docstring (you can copy and then alter the one from bake_time_remaining.)
def elapsed_time_in_minutes(cam, mint):
    """Calculate the elapsed time.
    :param cam: int the number of layers in the lasagna
    :param mint: int elapsed cooking time
    ...
    """
    return preparation_time_in_minutes(cam) + mint
